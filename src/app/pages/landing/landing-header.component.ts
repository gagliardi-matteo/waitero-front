  ...
  template: `
    <header class="landing-header"><div class="landing-shell header-inner">
      ...
      <nav id="landing-nav" class="landing-nav" [class.is-open]="menuOpen" aria-label="Navigazione principale">
        <a href="#come-funziona" (click)="goToSection($event, 'come-funziona')">Come funziona</a><a href="#perche" (click)="goToSection($event, 'perche')">Perché WaiterO</a><a href="#funzionalita" (click)="goToSection($event, 'funzionalita')">Funzionalità</a><a href="#ristoratori" (click)="goToSection($event, 'ristoratori')">Per i ristoratori</a><a href="#contatti" (click)="goToSection($event, 'contatti')">Contatti</a>
